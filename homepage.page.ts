...
export class HomePage {
    ...
    constructor(page: Page) {
        ...
        this.styleOfArtworkDropDown = page.locator("//label[contains(text(),'Style Of Artwork *')]//following-sibling::div//input")
        this.styleOfArtWorkRadioBox = page.locator("//div[contains(@id,'react-select-') and @role='listbox']//input")
        this.nftGenesisDropDown = page.locator("//div[contains(text(),'Select NFT Genesis')]//following-sibling::div//input")
        this.nftGenesisRadioBox = page.locator("//div[contains(@id,'react-select-') and @role='listbox']//input")
        this.supplyDropDown = page.locator("//div[contains(text(),'Select Supply')]//following-sibling::div//input")
        ...
        this.marketplaceMintedOnDropDown = page.locator("//span[contains(text(),'Select Marketplace')]/../..")
